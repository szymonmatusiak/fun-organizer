...
class EventItemsAdapter(private val itemsGropusList: MutableList<SingleItemModel>, private val iAmHost:Boolean, private val isEnough:Boolean,private val eventItemsListener: EventItemsListener)
    ...
    override fun onBindViewHolder(eventViewHolder: EventItemsHolder, position: Int) {
        eventViewHolder.setData(itemsGropusList.get(position), iAmHost, isEnough,  eventItemsListener)
    }
